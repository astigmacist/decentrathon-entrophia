...
export default function SubmitAssetPage() {
  ...
  const handleSubmit = async () => {
    if (!activeWallet) { toast.error('Set x-wallet or connect wallet first'); throw new Error(); }
  ...
  if (!activeWallet) {
    return (
      <div className="app-container page-wrap">
        ...
        <p className="text-slate-400">Set `x-wallet` in top bar or connect your Solana wallet to submit an invoice asset.</p>
        </div>
      </div>
    );
  }
